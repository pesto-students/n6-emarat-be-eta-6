...
const getFirstMonthPaymentAmount = ({ createdAt, monthlyFee }) => {
...
export const calculatePaymentAmountV2 = ({createdAt, lastPaymentAt, amenities = []}) => {
    ...
    if(isFirstPayment) return getFirstMonthPaymentAmount({createdAt, monthlyFee});
    ...
    return { pay: +monthlyFee.toFixed(2), paymentMonth };
}
