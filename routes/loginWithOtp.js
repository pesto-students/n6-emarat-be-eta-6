...
import { OTP_EXPIRE_TIME_IN_MINUTES, TEST_MASTER_OTP } from "../lib/constants.js";
...
router.post('/otp', async (req, res) => {
    ...
    const mobileWithOtp =  new loginModel({phone: req.body.phone, otp })
...
router.post('/loginwithotp', async (req, res) => {
    ...
    res.send(getResponseFormat({token}));
});
